...
export default class AdminRegister extends Component {
  ...
  onSubmit = (e) => {
    ...
    localStorage.setItem('staff_id', this.state.staffID);
    ...
    return (
      ...
      <div className="App">
        ...
        <Text>Admin Register</Text>
          ...
          <Form.Group controlId="formBasicEmail">
            <Form.Control type="text" placeholder="Staff ID" onChange={this.onChangeStaffID} required/>
          </Form.Group>

          <Form.Group controlId="formBasicEmail">
            <Form.Control type="email" placeholder="Staff Email" onChange={this.onChangeEmail} required/>
          </Form.Group>
          ...
          <hr/>
          <a href="/" role="button"><h6 class="register-text">Already an admin? Login here.</h6></a>
        </Form>
        </Body>
      </div>
      </BrowserRouter>
